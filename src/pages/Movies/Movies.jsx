...
import Shivek from "../../Components/PAGE3/shivek.png";
import "./styles.css";
...
function Movies() {
  ...
  // selectedMoviesByUser looks like
  ...
  //   { id: 10749, name: "Romance" }
  // ]
  // Now we have extracted the genre list from advancemoviesearch api.
  // now we will map our id(userselected) to genre_list id. so that
  // we can further use this api more
  ...
  //     const url =
  //       "https://advanced-movie-search.p.rapidapi.com/discover/movie?with_genres=${id}&page=1";
  //     const options = {
  //       method: "GET",
  //       headers: {
  //         "X-RapidAPI-Key":
  ...
  //     return fetchMovies(genre.id); //For each genre object, fetchMovies is
  //     //called with the genre's ID  to fetch movies for that genre.
  //   }); //array of promises
  //   //     // promises=[
  //   //   // Promise for fetching Action movies
  //   //       Promise,
  //   //   // Promise for fetching Drama movies
  //   //   Promise,
  //   //   // Promise for fetching Romance movies
  //   //   Promise
  //   // ]
  //   promises.forEach(async (promise, index) => {
  //     // Delay each request by 5 seconds multiplied by the index
  //     setTimeout(async () => {
  //       try {
  //         const result = await promise;
  //         const parsedResult = JSON.parse(result);
  //         setMovies((prev) => [...prev, parsedResult]);
  //       } catch (error) {
  //         console.error("Error fetching movies:", error);
  //       }
  //     }, index * 5000); // Increase the delay for each subsequent request
  //   });
  // }, [selectedGenresToFetch]);
  ...
  return (
    <div className="app-container">
      <div className="header">
        <p className="app-title">Super app</p>
        <img
          ...
          <div key={genre.id} className="genre-container">
            ...
            <div className="movies-container">
              {movies
                ...
                .map((filteredMovie) => (
                  <div key={filteredMovie.id} className="movie-card">
                    <img
                      height={150}
                      width={300}
